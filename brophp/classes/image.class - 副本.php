 ...
 * ******************************************************************************/
	class Image {
		 ...
		 */
		function thumb($name, $width, $height,$qz="th_",$newpath){
		...
		*/
		function cut($name, $x, $y, $width, $height, $qz="cu_",$newpath){
			$imgInfo=$this->getInfo($name);                                 //获取图片信息
			...
			return $this->createNewImage($cutimg, $qz.$name,$imgInfo,$newpath);    //返回新生成的缩略图的名称，以"cu_"为前缀
		}
